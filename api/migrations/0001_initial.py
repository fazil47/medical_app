    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to=api.models.profile_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accepted_start_time', models.TimeField(blank=True, null=True)),
                ('accepted', models.BooleanField(default=False)),
                ('rejected', models.BooleanField(default=False)),
                ('patient_message', models.CharField(blank=True, max_length=280, null=True)),
                ('doctor_message', models.CharField(blank=True, max_length=280, null=True)),
